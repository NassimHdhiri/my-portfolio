  ...
  return (
    <section className="bg-white  :bg-gray-900">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h5 className="mb-4 text-xl font-normal tracking-tight text-center text-gray-900  :text-white">
          Get Touch
        </h5>
        ...
        <form action="#" className="space-y-8" onSubmit={handleForm}>
          <div>
            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900  :text-gray-300">
              Your email
            </label>
            <input
              type="email"
          ...
          <div>
            <label htmlFor="subject" className="block mb-2 text-sm font-medium text-gray-900  :text-gray-300">
              Name
            </label>
            <input
              type="text"
          ...
          <div className="sm:col-span-2">
            <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900  :text-gray-400">
              Your message
            </label>
            <textarea
              id="message"
