...
export default function Resume() {
  return (
    <div className='flex flex-col items-center xs:gap-y-1'>
        {/* first line */}
        <div className='flex items-center gap-5 xs:pl-16'>
            <img src={GlobalWorld} alt='world_icon' className=' xs:w-8' />
            <h2 className='xs:text-xl lg:text-[37px] capitalize font-light'>Hello ,I'm</h2>
        </div>

        {/* 2nd line */}
        <div className='xs:flex xs:flex-col xs:gap-y-1'>
            <h2 className=' xs:text-xl  lg:text-[50px]  capitalize font-bold lg:pl-7 xs:pl-20 leading-[90px] '>hdhiri Mohamed nassim</h2>
            <h2 className=' xs:text-lg   lg:text-[30px]  capitalize xs:pl-24 lg:pl-10  '>full stack developer</h2>
        </div>
    </div>
