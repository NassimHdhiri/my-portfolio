...
import ExpAcademicCapture from '../../../assets/Profile_about_me/images/section-experiences.svg';
  ...
  return (
    <div className='grid grid-rows-3 justify-center gap-7'>
      ...
      <div className=' row-span-3 '>
          <div className=' bg-gray-400 h-96 flex flex-col gap-5 items-center p-9 rounded-[42px]'>
